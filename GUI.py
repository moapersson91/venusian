...
def main(datapath='processed_data/',datafile='venus_specData', regionpath='',regionfile='data', orbitpath='', orbitfile='orbits'):
    ...
    data = IO.get_data(filepath=datapath, filename=datafile)
    orbits = get_orbits(data)
    ...
    orbit, index = get_next_orbit(list(region.get(), orbits)
    n.set(index)
